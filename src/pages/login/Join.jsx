        ...
        >
          ...
          >
            ...
            >
              ...
              {"\n\n"}
              1. 목적{"\n"}이 약관은 정석케미칼(전자거래 사업자)이 운영하는
              정석케미칼(이하 "홈페이지"이라 한다)에서 제공하는 인터넷 관련
              서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버홈페이지과
              이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. ※
              「PC통신 등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는
              한 이 약관을 준용합니다」
              {"\n\n"}
              2. 회원의 의무{"\n"}① "홈페이지" 이란 사업자가 재화 또는 용역을
              이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화
              또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러
              사이버홈페이지을 운영하는 사업자의 의미로도 사용합니다. ②
              "이용자"란 "홈페이지"에 접속하여 이 약관에 따라 "홈페이지"이
              제공하는 서비스를 받는 회원 및 비회원을 말합니다. ③ '회원'이라
              함은 "홈페이지"에 개인정보를 제공하여 회원등록을 한 자로서,
              "홈페이지"의 정보를 지속적으로 제공받으며, "홈페이지"이 제공하는
              서비스를 계속적으로 이용할 수 있는 자를 말합니다. ④ 비회원'이라
              함은 회원에 가입하지 않고 "홈페이지"이 제공하는 서비스를 이용하는
              자를 말합니다.
            </div>

            {/* ✅ 동의 체크박스 + 문구 (문구 클릭해도 체크되게) */}
            <label
              style={{
                display: "flex",
                alignItems: "center",
            ...
            >
              ...
              <span style={{ fontSize: "14px" }}>
                위 <span style={{ fontWeight: "bold" }}>이용약관</span>을 모두
                읽고 동의합니다.
              </span>
            </label>
